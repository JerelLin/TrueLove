		...
		_createClass(Login, [{
			...
			value: function handleLogin(event) {
				...
				_superagent2.default.post("/login").send({
					...
					localStorage.setItem("marriage_token", res.body.token); //存储token
					setTimeout(function () {
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								...
								_react2.default.createElement("input", { className: "submit", id: "submit", type: "submit", name: "submit", value: "登录", onClick: function onClick(event) {
							...
							_react2.default.createElement(
								...
								_react2.default.createElement(
									_reactRouter.Link,
									{ to: "/reset_password", className: "find_password" },
									"找回密码"
								),
								_react2.default.createElement(
									_reactRouter.Link,
									{ to: "/register", className: "free_register" },
									"免费注册"
								)
							)
						)
