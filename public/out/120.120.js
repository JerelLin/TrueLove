...
/***/ function(module, exports, __webpack_require__) {
	...
	var Page_Grow = function (_React$Component) {
		_inherits(Page_Grow, _React$Component);

		function Page_Grow(props) {
			_classCallCheck(this, Page_Grow);

			var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(Page_Grow).call(this, props));
			...
			var grow_data = [{
				label: 'flow_recen_visitor',
				values: [{ x: "2 14", y: 1000 }, { x: "2 13", y: 800 }, { x: "2 12", y: 850 }, { x: "2 11", y: 1100 }, { x: "2 10", y: 1150 }, { x: "2 9", y: 1400 }, { x: "2 8", y: 700 }]
			}, {
				label: 'flow_recent_visited',
				values: [{ x: "2 14", y: 800 }, { x: "2 13", y: 600 }, { x: "2 12", y: 1050 }, { x: "2 11", y: 1000 }, { x: "2 10", y: 1000 }, { x: "2 9", y: 900 }, { x: "2 8", y: 500 }]
			}];
			_this.state = {
				flow_sum: flow_sum,
		...
		_createClass(Page_Grow, [{
			key: "componentDidMount",
			value: function componentDidMount() {
				/*初始化主页增长数据(默认获取近七天数据)*/
				_superagent2.default.get("/initPageGrow").end(function (err, res) {
					if (err || !res.ok) {
						console.log(err);
						console.log(res);
						return false;
			...
			value: function onSelectDate(value) {
				_superagent2.default.get("/getFlowByDate").accept('application/json') /*接收什么类型的数据*/
			...
			value: function render() {
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							"div",
							{ className: "flow_title" },
							"累计流量统计"
						),
						_react2.default.createElement(
							"div",
							{ className: "flow_sum_table" },
							_react2.default.createElement(
								"table",
								{ className: "table" },
								_react2.default.createElement(
									...
									_react2.default.createElement(
										...
										_react2.default.createElement(
											"td",
											null,
											this.state.flow_sum.click_sum
										),
										_react2.default.createElement(
											"td",
											null,
											this.state.flow_sum.visitor_sum
										),
										_react2.default.createElement(
											"td",
											null,
											this.state.flow_sum.click_average
										)
									)
								)
							)
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								...
								_react2.default.createElement(
									...
									this.state.flow_recent.data.map(function (element, index) {
										return _react2.default.createElement(
											"tr",
											{ key: index },
											_react2.default.createElement(
						...
						_react2.default.createElement(
							"div",
							{ className: "flow_d3_show" },
							_react2.default.createElement(
								"div",
								{ className: "flow_d3_show_title" },
								" 增长趋势"
							),
							_react2.default.createElement(
								"div",
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../../../node_modules/css-loader/index.js!./page_grow.css", function() {
				var newContent = require("!!./../../../../node_modules/css-loader/index.js!./page_grow.css");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".page_flow .flow_sum{\r\n\twidth:100%;\r\n\tmin-height:200px;\r\n}\r\n.page_flow .flow_recent{\r\n\twidth:100%;\r\n\tmin-height:500px;\r\n}\r\n.page_flow .flow_title{\r\n\twidth:100%;\r\n\theight:50px;\r\n\tcolor:#434343;\r\n\tfont-size:16px;\r\n\tline-height:50px;\r\n}\r\n/*表单样式*/\r\n.page_flow .table{\r\n\tmargin-top:20px;\r\n\twidth:100%;\r\n\tborder:1px solid #b6b6b6;\r\n\tborder-collapse:collapse;\r\n}\r\n.page_flow .table_header{\r\n\tbackground-color:#3b8ede;\r\n}\r\n.page_flow .table tr{\r\n\twidth:100%;\r\n\theight:40px;\r\n\tborder-bottom:1px solid #b6b6b6;\r\n}\r\n/*.page_flow .table tr:hover{\r\n\tbackground-color:#3b8ede;\r\n}\r\n.page_flow .table tr:hover td{\r\n\tcolor:#FFF;\r\n}*/\r\n.page_flow .table td{\r\n\tcolor:#434343;\r\n\tfont-size:14px;\r\n\ttext-align:center;\r\n}\r\n.page_flow .table_header td{\r\n\tcolor:#FFF;\r\n}\r\n/*表单样式-end*/\r\n\r\n/* 日期下拉样式补充*/\r\n.page_flow .date_option{\r\n\twidth:100%;\r\n\theight:80px;\r\n\t/*border:1px solid #b6b6b6;*/\r\n}\r\n.page_flow .date_option label{\r\n\tcolor:#434343;\r\n\tfont-size:15px;\r\n\tmargin-right:25px;\r\n\tmargin-top:20px;\r\n}\r\n.page_flow .date_option .select{\r\n\tdisplay:inline-block;\r\n\tmargin-top:20px;\r\n}\r\n/* 日期下拉样式补充-end*/\r\n\r\n/*增长趋势*/\r\n.page_flow .flow_d3_show .note{\r\n\twidth:100%;\r\n\theight:60px;\r\n\t/*border:1px solid #666;*/\r\n\tposition:relative;\r\n}\r\n.page_flow .flow_d3_show .visitor{\r\n\tmargin-top:5px;\r\n\twidth:100px;\r\n\theight:25px;\r\n\tfont-size:14px;\r\n\tbackground-color:#6da4d6;\r\n\tposition:absolute;\r\n\tright:10px;\r\n\ttop:5px;\r\n\tcolor:#FFF;\r\n}\r\n.page_flow .flow_d3_show .visited{\r\n\twidth:100px;\r\n\theight:25px;\r\n\tfont-size:14px;\r\n\tbackground-color:#f08b6a;\r\n\tposition:absolute;\r\n\tright:10px;\r\n\ttop:30px;\r\n\tcolor:#FFF;\r\n}\r\n.page_flow .flow_d3_show{\r\n\tmargin-top:40px;\r\n\twidth:100%;\r\n\tmin-height:450px;\r\n\t/*border:1px solid #e3e3e3;*/\r\n}\r\n.page_flow .flow_d3_show .flow_d3_show_title{\r\n\twidth:100%;\r\n\theight:50px;\r\n\tcolor:#434343;\r\n\tfont-size:16px;\r\n\tline-height:50px;\r\n}\r\n/*增长趋势-end*/", ""]);
