...
/***/ function(module, exports, __webpack_require__) {
	...
	var Page_Property = function (_React$Component) {
		_inherits(Page_Property, _React$Component);

		function Page_Property(props) {
			_classCallCheck(this, Page_Property);

			var _this2 = _possibleConstructorReturn(this, Object.getPrototypeOf(Page_Property).call(this, props));

			var sex_data = [{
				label: 'man',
				values: [{ x: "2.14", y: 1000 }, { x: "2.15", y: 800 }, { x: "2.16", y: 850 }, { x: "2.17", y: 1100 }, { x: "2.18", y: 1150 }, { x: "2.19", y: 1400 }, { x: "2.20", y: 700 }]
			}, {
				label: 'woman',
				values: [{ x: "2.14", y: 500 }, { x: "2.15", y: 600 }, { x: "2.16", y: 1050 }, { x: "2.17", y: 700 }, { x: "2.18", y: 1300 }, { x: "2.19", y: 1500 }, { x: "2.20", y: 900 }]
			}];
			var age_data = [{
				label: 'man',
		...
		_createClass(Page_Property, [{
			...
			value: function componentDidMount() {
				...
				_superagent2.default.get("/initPageProperty").end(function (err, res) {
					if (err || !res.ok) {
						console.log(err);
						console.log(res);
						return false;
			...
			value: function onSelectDate(value) {
				...
				_superagent2.default.get("/PagePropertyFlow").accept('application/json') /*接收什么类型的数据*/
				.query({
					type: "sex", /*性别类型*/
			...
			key: "requestPageStatistic",
			value: function requestPageStatistic(type, option) {
				var _this = this;
				if (type == "sex") {
					this.setState({
						sexoption: option
					});
					_superagent2.default.get("/PagePropertyFlow").accept('application/json').query({
						type: type,
			...
			value: function render() {
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							"div",
							{ className: "visitedSelect" },
							_react2.default.createElement(
								_buttonControl2.default,
								{ onSelectType: function onSelectType(option) {
										return _this3.requestPageStatistic("sex", option);
									} },
								_react2.default.createElement("input", { type: "button", value: "主页访问次数" }),
								_react2.default.createElement("input", { type: "button", value: "主页访问人数" })
							)
						),
						_react2.default.createElement(
							"div",
							...
							_react2.default.createElement(
								...
								{ initValue: "最近七天", onSelectOption: function onSelectOption(value) {
										return _this3.onSelectDate(value);
									} },
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								_buttonControl2.default,
								{ onSelectType: function onSelectType(option) {
										return _this3.requestPageStatistic("age", option);
									} },
								_react2.default.createElement("input", { type: "button", value: "主页访问次数" }),
								_react2.default.createElement("input", { type: "button", value: "主页访问人数" })
							)
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								_buttonControl2.default,
								{ onSelectType: function onSelectType(option) {
										return _this3.requestPageStatistic("education", option);
									} },
								_react2.default.createElement("input", { type: "button", value: "主页访问次数" }),
								_react2.default.createElement("input", { type: "button", value: "主页访问人数" })
							)
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								_buttonControl2.default,
								{ onSelectType: function onSelectType(option) {
										return _this3.requestPageStatistic("salary", option);
									} },
								_react2.default.createElement("input", { type: "button", value: "主页访问次数" }),
								_react2.default.createElement("input", { type: "button", value: "主页访问人数" })
							)
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../../../node_modules/css-loader/index.js!./page_property.css", function() {
				var newContent = require("!!./../../../../node_modules/css-loader/index.js!./page_property.css");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".page_userProperty{\r\n\twidth:954px;\r\n\tmargin-left:-50px;\r\n}\r\n\r\n/*布局*/\r\n.page_userProperty .userProperty_section{\r\n\twidth:100%;\r\n\tmin-height:555px;\r\n}\r\n.page_userProperty .userProperty_section .title{\r\n\twidth:100%;\r\n\theight:48px;\r\n\tbackground-color:#3b8ede;\r\n\tcolor:#FFF;\r\n\tline-height:48px;\r\n\tfont-size:16px;\r\n\tpadding-left:20px;\r\n}\r\n\r\n/*访问次数or访问人数*/\r\n.page_userProperty .visitedSelect{\r\n\twidth:99.9%;\r\n\theight:35px;\r\n\tbackground-color:#f4f5f9;\r\n}\r\n\r\n/*男女标注*/\r\n.page_userProperty .userProperty_section .note{\r\n\twidth:100%;\r\n\theight:60px;\r\n\t/*border:1px solid #666;*/\r\n\tposition:relative;\r\n}\r\n.page_userProperty .note .man{\r\n\tmargin-top:5px;\r\n\twidth:100px;\r\n\theight:25px;\r\n\tfont-size:14px;\r\n\tbackground-color:#6da4d6;\r\n\tposition:absolute;\r\n\tright:10px;\r\n\ttop:5px;\r\n\tcolor:#FFF;\r\n}\r\n.page_userProperty .note .woman{\r\n\twidth:100px;\r\n\theight:25px;\r\n\tfont-size:14px;\r\n\tbackground-color:#f08b6a;\r\n\tposition:absolute;\r\n\tright:10px;\r\n\ttop:30px;\r\n\tcolor:#FFF;\r\n}\r\n\r\n/*性别*/\r\n.sex{}\r\n\t/* 日期下拉样式补充*/\r\n.page_userProperty .date_option{\r\n\twidth:100%;\r\n\theight:80px;\r\n\t/*border:1px solid #b6b6b6;*/\r\n}\r\n.page_userProperty .date_option label{\r\n\tcolor:#434343;\r\n\tfont-size:15px;\r\n\tmargin-left: 20px;\r\n\tmargin-right:25px;\r\n\tmargin-top:20px;\r\n}\r\n.page_userProperty .date_option .select{\r\n\tdisplay:inline-block;\r\n\tmargin-top:20px;\r\n}\r\n\t/* 日期下拉样式补充-end*/\r\n/*性别-end*/\r\n\r\n/*年龄*/\r\n.age{}\r\n\r\n/*学历*/\r\n.education{}\r\n\r\n/*薪水*/\r\n.salary{}", ""]);
