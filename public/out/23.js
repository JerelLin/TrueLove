webpackJsonp([23,17],Array(284).concat([
/* 284 */
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _table = __webpack_require__(369);

	var _table2 = _interopRequireDefault(_table);

	var _css4 = __webpack_require__(247);
	...
	var News = function (_React$Component) {
		...
		_createClass(News, [{
			...
			value: function componentDidMount() {
				...
				(0, _fetch.fetch_data_get)("/marriage_api/init_news", { token: localStorage.marriage_app_token }).then(function (result) {
					var news_list_data = [];
					result.body.news_list_data.map(function (ele, key) {
						news_list_data.push({
							key: key,
							news_id: ele.news_id,
							subject: ele.subject,
			...
			key: "preview",
			value: function preview(news_id) {
				var _this3 = this;

				this.setState({ preview_visible: true, news_detail_loading: true });
				(0, _fetch.fetch_data_get)("/marriage_api/get_news_detail", { token: localStorage.marriage_app_token, news_id: news_id }).then(function (result) {
					_this3.setState({ news_detail_loading: false, news_detail: result.body.news_detail });
				}).catch(function (error) {
					console.log(error);
				});
			}
			...
			key: "delete_news",
			value: function delete_news(news_id) {
				var _this = this;
				(0, _fetch.fetch_data_get)("/marriage_api/delete_news", { token: localStorage.marriage_app_token, news_id: news_id }).then(function (result) {
			...
			value: function render() {
				...
				var columns = [{ title: "消息ID", dataIndex: "news_id", key: "news_id", render: function render(text) {
						return _react2.default.createElement(
							"span",
							null,
							text
						);
					} }, { title: "消息主题", dataIndex: "subject", key: "subject" }, { title: "发布时间", dataIndex: "date", key: "date" }, { title: "操作", key: "operation", render: function render(text, record) {
						return _react2.default.createElement(
							"span",
							{ className: "operation" },
							_react2.default.createElement(
								...
								{ href: "#", onClick: function onClick() {
										return _this4.preview(record.news_id);
									} },
								"查看"
							),
							...
							_react2.default.createElement(
								"a",
								{ href: "#", onClick: function onClick() {
										return _this4.delete_news(record.news_id);
									} },
								"删除"
							)
						);
				...
				return _react2.default.createElement(
					"div",
					{ className: "news" },
					_react2.default.createElement(_subject2.default, { subject_content: "消息中心" }),
					_react2.default.createElement(
						"div",
						{ className: "news_main" },
						_react2.default.createElement(
							_spin2.default,
							{ size: "large", spinning: this.state.news_loading },
							_react2.default.createElement(_table2.default, { columns: columns, dataSource: this.state.news_list_data })
						)
					),
					_react2.default.createElement(
						_modal2.default,
						{ wrapClassName: "news_preview_box",
							width: "680",
							title: "消息查看",
						...
						_react2.default.createElement(
							_spin2.default,
							{ spinning: this.state.news_detail_loading },
							_react2.default.createElement(
								"iframe",
								{ srcDoc: this.state.news_detail, frameBorder: "0", width: "100%", height: "350px" },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Modal = __webpack_require__(330);

	var _Modal2 = _interopRequireDefault(_Modal);

	var _confirm = __webpack_require__(340);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _rcDialog = __webpack_require__(331);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _LazyRenderBox = __webpack_require__(335);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _locale = __webpack_require__(341);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _rcTable = __webpack_require__(371);
	...
	var _filterDropdown = __webpack_require__(386);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _TableRow = __webpack_require__(373);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _TableCell = __webpack_require__(379);

	var _TableCell2 = _interopRequireDefault(_TableCell);

	var _ExpandIcon = __webpack_require__(382);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var fetchKeys = __webpack_require__(375);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _objectPath = __webpack_require__(380);
	  ...
	  function factory(options) {
	    ...
	    objectPath.has = function (obj, path) {
	      ...
	      for (var i = 0; i < path.length; i++) {
	        var j = getKey(path[i]);
	        if (typeof j === 'number' && isArray(obj) && j < obj.length || (options.includeInheritedProps ? j in Object(obj) : _hasOwnProperty.call(obj, j))) {
	          obj = obj[j];
	        } else {
	          return false;
	        }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Group = __webpack_require__(385);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _dropdownButton = __webpack_require__(426);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _rcDropdown = __webpack_require__(405);
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".news_main{\r\n\twidth: 100%;\r\n\tmin-height: 800px;\r\n\tmargin: 0 auto;\r\n\tpadding: 20px 30px;\r\n}\r\n.news_main .ant-table td{\r\n\tmax-width: 80px !important;\r\n}\r\n.news_main .ant-table td span{\r\n\tdisplay: block;\r\n\tmax-height: 36px !important;\r\n\toverflow: hidden;\r\n\twhite-space: nowrap;\r\n\ttext-overflow: ellipsis;\r\n}\r\n.news_main .ant-table .ant-divider{\r\n\tdisplay: inline-block !important;\r\n}", ""]);
