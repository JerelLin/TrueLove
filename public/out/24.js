...
/***/ function(module, exports, __webpack_require__) {
	...
	var _css2 = __webpack_require__(360);
	...
	var Material = function (_React$Component) {
		...
		function Material(props) {
			...
			var _this2 = _possibleConstructorReturn(this, Object.getPrototypeOf(Material).call(this, props));
		...
		_createClass(Material, [{
			...
			value: function componentDidMount() {
				...
				_this.init_material(1).then(function (result) {
					_this.setState({
						material_list_data_loading: false,
			...
			key: "material_delete",
			value: function material_delete(material_id) {
				var _this = this;
				(0, _fetch.fetch_data_get)("/marriage_api/delete_material", { token: localStorage.marriage_app_token, material_id: material_id }).then(function (result) {
			...
			value: function onChange(page) {
				...
				_this.init_material(page).then(function (result) {
					_this.setState({
						material_list_data_loading: false,
						material_list_total: result.body.material_list_total,
						material_list_data: result.body.material_list_data
			...
			key: "init_material",
			value: function init_material(page_number) {
				return new Promise(function (resolve, reject) {
					(0, _fetch.fetch_data_get)("/marriage_api/init_material", { token: localStorage.marriage_app_token, page_number: page_number }).then(function (result) {
						resolve(result);
					}).catch(function (error) {
						reject(error);
					});
			...
			value: function render() {
				...
				return _react2.default.createElement(
					"div",
					{ className: "material" },
					_react2.default.createElement(_subject2.default, { subject_content: "素材库" }),
					_react2.default.createElement(
						_spin2.default,
						{ size: "large", spinning: this.state.material_list_data_loading },
						_react2.default.createElement(
							"div",
							{ className: "material_main" },
							this.state.material_list_data.length != 0 ? this.state.material_list_data.map(function (element, index) {
								return _react2.default.createElement(
									"div",
									{ key: index, className: "material_data" },
									_react2.default.createElement(
										"div",
										{ className: "material_left" },
										_react2.default.createElement("img", { src: element.material_img })
									),
									_react2.default.createElement(
										"div",
										{ className: "material_right" },
										_react2.default.createElement(
											"div",
											{ className: "material_text" },
											_react2.default.createElement(
												"div",
												{ className: "material_subject" },
												element.material_subject
											),
											_react2.default.createElement(
												"div",
												{ className: "material_content" },
												element.material_content
											)
										),
										_react2.default.createElement(
											"div",
											{ className: "material_action" },
											_react2.default.createElement(
												"span",
												{ className: "material_edit" },
												_react2.default.createElement(
													_reactRouter.Link,
													{ to: "/marriage_app/activity_publish", state: { material_data: element } },
													"编辑"
												)
											),
											...
											_react2.default.createElement(
												...
												{ className: "material_delete", onClick: function onClick() {
														return _this3.material_delete(element.material_id);
													} },
												_react2.default.createElement(
													"a",
													{ href: "#" },
							...
							_react2.default.createElement(
								...
								_react2.default.createElement(_pagination2.default, { onChange: function onChange(page) {
									...
									}, current: this.state.page_number, total: this.state.material_list_total, pageSize: 5 })
							)
						)
					)
				);
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".material_main{\r\n\twidth: 852px;\r\n\tmin-height: 800px;\r\n\tmargin: 0 auto;\r\n}\r\n.material_data{\r\n\twidth: 100%;\r\n\theight: 225px;\r\n\tborder: 1px solid #ededed;\r\n\tmargin-top:20px;\r\n\toverflow: hidden;\r\n\t-webkit-transition: box-shadow .5s;\r\n\t-moz-transition: box-shadow .5s;\r\n\ttransition: box-shadow .5s;\r\n}\r\n.material_data:hover{\r\n\tbox-shadow: 5px 5px 5px #ededed;\r\n}\r\n.material_left{\r\n\twidth: 25%;\r\n\theight: 100%;\r\n\tfloat: left;\r\n\toverflow: hidden;\r\n}\r\n.material_left img{\r\n\theight: 80%;\r\n\tmargin: 10% 20px;\r\n}\r\n.material_right{\r\n\twidth: 75%;\r\n\theight: 100%;\r\n\tfloat: right;\r\n\toverflow: hidden;\r\n}\r\n.material_right .material_text{\r\n\twidth: 100%;\r\n\theight: 70%;\r\n\tpadding: 20px;\r\n}\r\n.material_right .material_text .material_subject{\r\n\theight: 16%;\r\n\twidth: 80%;\r\n\tfont-size: 14px;\r\n}\r\n.material_right .material_text .material_content{\r\n\tmargin-top: 2%;\r\n\theight: 82%;\r\n\twidth: 88%;\r\n\tfont-size: 12px;\r\n\tline-height: 20px;\r\n\toverflow: hidden;\r\n}\r\n.material_right .material_action{\r\n\twidth: 100%;\r\n\theight: 30%;\r\n\tpadding: 20px;\r\n}\r\n.material_right .material_action .material_edit,.material_right .material_action .material_delete,.material_right .material_action .material_date{\r\n\tpadding: 0 10px;\r\n}\r\n.material_empty{\r\n\ttext-align: center;\r\n\tmargin: 20px auto;\r\n}\r\n.material_pagination{\r\n\twidth: 100%;\r\n\theight: 50px;\r\n\tmargin-top: 20px;\r\n\toverflow: hidden;\r\n}\r\n.material_pagination .ant-pagination{\r\n\tfloat: right;\r\n}", ""]);
