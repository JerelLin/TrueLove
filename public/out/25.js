...
/***/ function(module, exports, __webpack_require__) {
	...
	var Activity_management = function (_React$Component) {
		...
		function Activity_management(props) {
			...
			var _this2 = _possibleConstructorReturn(this, Object.getPrototypeOf(Activity_management).call(this, props));
		...
		_createClass(Activity_management, [{
			...
			value: function componentDidMount() {
				...
				_this.init_activity(1).then(function (result) {
					_this.setState({
						activity_list_loading: false,
			...
			key: "activity_delete",
			value: function activity_delete(activity_id) {
				var _this = this;
				(0, _fetch.fetch_data_get)("/marriage_api/delete_activity", { token: localStorage.marriage_app_token, activity_id: activity_id, page_number: this.state.page_number }).then(function (result) {
			...
			value: function onChange(page) {
				...
				_this.init_activity(page).then(function (result) {
					_this.setState({
						activity_list_loading: false,
						activity_list_total: result.body.activity_list_total,
						activity_list_data: result.body.activity_list_data
			...
			key: "init_activity",
			value: function init_activity(page_number) {
				return new Promise(function (resolve, reject) {
					(0, _fetch.fetch_data_get)("/marriage_api/init_activity", { token: localStorage.marriage_app_token, page_number: page_number }).then(function (result) {
						resolve(result);
					}).catch(function (error) {
						reject(error);
					});
			...
			value: function render() {
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(_subject2.default, { subject_content: "相亲活动管理" }),
					_react2.default.createElement(
						"div",
						{ className: "activity_management_main" },
						_react2.default.createElement(
							_spin2.default,
							{ size: "large", spinning: this.state.activity_list_loading },
							this.state.activity_list_data.length != 0 ? this.state.activity_list_data.map(function (element, index) {
								return _react2.default.createElement(
									"div",
									{ key: index, className: "activity_data" },
									_react2.default.createElement(
										"div",
										{ className: "activity_left" },
										_react2.default.createElement("img", { src: element.activity_cover })
									),
									_react2.default.createElement(
										"div",
										{ className: "activity_right" },
										_react2.default.createElement(
											"div",
											...
											_react2.default.createElement(
												...
												element.activity_subject
											),
											_react2.default.createElement(
												"div",
												{ className: "activity_content" },
												element.activity_content
											)
										),
										_react2.default.createElement(
											"div",
											{ className: "activity_action" },
											_react2.default.createElement(
												"span",
												{ className: "activity_delete", onClick: function onClick() {
														return _this3.activity_delete(element.activity_id);
													} },
												_react2.default.createElement(
													"a",
													{ href: "#" },
											...
											_react2.default.createElement(
												...
												_react2.default.createElement(
													_reactRouter.Link,
													{ to: "/marriage_app/activity_management/activity_detail", query: { activity_id: element.activity_id } },
													"查看"
												)
											),
											_react2.default.createElement(
												...
												_react2.default.createElement(
													...
													null,
													"阅读 ",
													element.activity_statistics.read
												),
												_react2.default.createElement(
													"span",
													null,
													"报名 ",
													element.activity_statistics.sign_up
												),
												_react2.default.createElement(
													"span",
													null,
													"评论 ",
													element.activity_statistics.comment
												)
											),
											_react2.default.createElement(
												"span",
								...
								"div",
								{ className: "activity_empty" },
								"这里是空的哦 ~ "
							)
						),
						_react2.default.createElement(
							"div",
							{ className: "activity_pagination" },
							_react2.default.createElement(_pagination2.default, { onChange: function onChange(page) {
									return _this3.onChange(page);
								}, current: this.state.page_number, total: this.state.activity_list_total, pageSize: 5 })
						)
					)
				);
			}
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".activity_management_main{\r\n\twidth: 852px;\r\n\tmin-height: 800px;\r\n\tmargin: 0 auto;\r\n}\r\n.activity_data{\r\n\twidth: 100%;\r\n\theight: 225px;\r\n\tborder: 1px solid #ededed;\r\n\tmargin-top:20px;\r\n\toverflow: hidden;\r\n\t-webkit-transition: box-shadow .5s;\r\n\t-moz-transition: box-shadow .5s;\r\n\ttransition: box-shadow .5s;\r\n}\r\n.activity_data:hover{\r\n\tbox-shadow: 5px 5px 5px #ededed;\r\n}\r\n.activity_left{\r\n\twidth: 25%;\r\n\theight: 100%;\r\n\tfloat: left;\r\n\toverflow: hidden;\r\n}\r\n.activity_left img{\r\n\theight: 80%;\r\n\tmargin: 10% 20px;\r\n}\r\n.activity_right{\r\n\twidth: 75%;\r\n\theight: 100%;\r\n\tfloat: right;\r\n\toverflow: hidden;\r\n}\r\n.activity_right .activity_text{\r\n\twidth: 100%;\r\n\theight: 70%;\r\n\tpadding: 20px;\r\n}\r\n.activity_right .activity_text .activity_subject{\r\n\theight: 16%;\r\n\twidth: 80%;\r\n\tfont-size: 14px;\r\n}\r\n.activity_right .activity_text .activity_content{\r\n\tmargin-top: 2%;\r\n\theight: 82%;\r\n\twidth: 88%;\r\n\tfont-size: 12px;\r\n\tline-height: 20px;\r\n\toverflow: hidden;\r\n}\r\n.activity_right .activity_action{\r\n\twidth: 100%;\r\n\theight: 30%;\r\n\tpadding: 20px;\r\n}\r\n.activity_right .activity_action .activity_statistics,.activity_right .activity_action .activity_delete,.activity_right .activity_action .activity_preview,.activity_right .activity_action .activity_date{\r\n\tpadding: 0 10px;\r\n}\r\n.activity_right .activity_action .activity_statistics span{\r\n\tpadding : 0 5px;\r\n}\r\n.activity_pagination{\r\n\twidth: 100%;\r\n\theight: 50px;\r\n\tmargin-top: 20px;\r\n\toverflow: hidden;\r\n}\r\n.activity_pagination .ant-pagination{\r\n\tfloat: right;\r\n}\r\n.activity_empty{\r\n\ttext-align: center;\r\n\tmargin: 20px auto;\r\n}", ""]);
