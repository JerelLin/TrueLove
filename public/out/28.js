...
/***/ function(module, exports, __webpack_require__) {
	...
	var _css2 = __webpack_require__(461);
	...
	var _activity_grow = __webpack_require__(880);

	var _activity_grow2 = _interopRequireDefault(_activity_grow);
	...
	var Activity_analysis = function (_React$Component) {
		...
		function Activity_analysis(props) {
			_classCallCheck(this, Activity_analysis);

			var _this2 = _possibleConstructorReturn(this, Object.getPrototypeOf(Activity_analysis).call(this, props));
		...
		_createClass(Activity_analysis, [{
			...
			value: function componentDidMount() {
				...
				(0, _fetch.fetch_data_get)("/marriage_api/get_activity_analysis_data", { token: localStorage.marriage_app_token }).then(function (result) {
					var activity_flow = result.body.activity_analysis_data.activity_flow;
			...
			value: function render() {
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(_subject2.default, { subject_content: "活动分析" }),
					_react2.default.createElement(
						"div",
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								...
								_react2.default.createElement(
									TabPane,
									{ tab: "用户增长", key: "1" },
									_react2.default.createElement(_activity_grow2.default, { activity_flow: this.state.activity_analysis_data.activity_flow })
								),
								_react2.default.createElement(
									TabPane,
									{ tab: "用户属性", key: "2" },
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".activity_analysis_main{\r\n\twidth: 852px;\r\n\tmargin: 0 auto;\r\n\tpadding-top: 30px;\r\n}", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ActivityGrow = function (_React$Component) {
		_inherits(ActivityGrow, _React$Component);

		function ActivityGrow(props) {
			_classCallCheck(this, ActivityGrow);

			return _possibleConstructorReturn(this, Object.getPrototypeOf(ActivityGrow).call(this, props));
		}

		_createClass(ActivityGrow, [{
			key: "onChange",
			...
			value: function render() {
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						"div",
						{ className: "activity_lsit" },
						this.props.activity_flow.length != 0 ? this.props.activity_flow.map(function (element, index) {
							return _react2.default.createElement(
								"div",
								{ className: "activity_item", key: index },
								_react2.default.createElement(
									"div",
									{ className: "activity_item_left" },
									_react2.default.createElement("img", { src: element.activity_cover })
								),
								_react2.default.createElement(
									"div",
									{ className: "activity_item_right" },
									_react2.default.createElement(
										"div",
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".activity_flow .label{\r\n\tpadding: 20px 0;\r\n}\r\n.activity_flow .activity_lsit{\r\n\t\r\n}\r\n.activity_flow .activity_item{\r\n\twidth: 99%;\r\n\theight: 225px;\r\n\tborder: 1px solid #ededed;\r\n\tmargin-top:20px;\r\n\toverflow: hidden;\r\n\t-webkit-transition: box-shadow .5s;\r\n\t-moz-transition: box-shadow .5s;\r\n\ttransition: box-shadow .5s;\r\n}\r\n.activity_flow .activity_item:hover{\r\n\tbox-shadow: 5px 5px 5px #ededed;\r\n}\r\n.activity_flow .activity_item_left{\r\n\twidth: 60%;\r\n\theight: 100%;\r\n\tfloat: left;\r\n\toverflow: hidden;\r\n}\r\n.activity_flow .activity_item_left img{\r\n\theight: 80%;\r\n\tmargin: 10% 20px;\r\n}\r\n.activity_flow .activity_item_right{\r\n\twidth: 40%;\r\n\theight: 100%;\r\n\tfloat: right;\r\n}\r\n.activity_flow .activity_item_right .activity_name{\r\n\twidth: 100%;\r\n\theight: 20%;\r\n\tmargin-top:20%;\r\n}\r\n.activity_flow .flow_stats{\r\n\twidth: 60%;\r\n\theight: 50%;\r\n\tfloat: left;\r\n}\r\n.activity_flow .flow_stats span{\r\n\tpadding-right: 30px;\r\n}\r\n.activity_pagination{\r\n\twidth: 100%;\r\n\theight: 50px;\r\n\tmargin-top: 20px;\r\n\toverflow: hidden;\r\n}\r\n.activity_pagination .ant-pagination{\r\n\tfloat: right;\r\n}\r\n.activity_empty{\r\n\ttext-align: center;\r\n\tmargin: 20px auto;\r\n}", ""]);
