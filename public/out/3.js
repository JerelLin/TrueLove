	...
	var Login = function (_React$Component) {
		...
		_createClass(Login, [{
			...
			value: function handleSubmit() {
				...
				(0, _fetch.fetch_data_post)("/marriage_api/login", { phoneNumber: phoneNumber, password: password }).then(function (result) {
					_this.setState({ login_loading: false });
			...
			value: function render() {
				...
				return _react2.default.createElement(
					"div",
					{ className: "login user_auth_box" },
					_react2.default.createElement(
						"div",
						{ className: "login_main user_auth_box_main" },
						_react2.default.createElement(_slogan2.default, null),
						_react2.default.createElement(
							"div",
							{ className: "login_form user_auth_form" },
							_react2.default.createElement(
								"div",
								{ className: "login_form_title user_auth_form_title" },
								"婚介所平台"
							),
							_react2.default.createElement(
								"div",
