	...
	var Material = function (_React$Component) {
		...
		function Material(props) {
			...
			var material_list_data = [{
				img: "../../../images/40dfde6fjw1e97vewqfy0j21ao0t6wqz.jpg",
				title: "寻找最美的她—大型相亲活动",
				date: "2015-12-24 12:39"
			}, {
				img: "../../../images/40dfde6fjw1e97vewqfy0j21ao0t6wqz.jpg",
				title: "寻找最美的她—大型相亲活动",
				date: "2015-12-24 12:39"
		...
		_createClass(Material, [{
			key: "material_rewrite",
			value: function material_rewrite(title) {
				console.log("已经成功获取到主题为" + title + "的素材的数据");
			}
			...
			key: "material_delete",
			value: function material_delete() {
				alert("确定要删除吗？");
			}
		}, {
			key: "render",
			value: function render() {
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						...
						this.state.material_list_data.map(function (element, index) {
							return _react2.default.createElement(
								"div",
								...
								_react2.default.createElement(
									...
									_react2.default.createElement(
										...
										_react2.default.createElement(
											...
											_react2.default.createElement(
												"div",
												{ className: "material_rewrite", onClick: function onClick() {
														return _this2.material_rewrite(element.title);
													} },
												"编辑"
											)
										),
